...
export interface TwoWayMappers<TListResp, TListData, TDetailResp, TDetailData, TCreateVars = any, TUpdateVars = any, TCreateResp = any, TCreateData = any> {
  ...
  /** transform response object to UI data */
  created?: MapperFn<TCreateResp, TCreateData>
